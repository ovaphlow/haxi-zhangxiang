...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='一般部件普查记录单';

-- 正在导出表  haxi.journal02_01 的数据：~13 rows (大约)
...
INSERT INTO `journal02_01` (`id`, `uuid`, `master_id`, `subject`, `approval_sn`, `train_sn`, `date`, `carriage`, `carriage_subject`, `time_begin`, `time_end`, `result`, `report`, `dept`, `executor`, `watcher`, `watcher_group`, `qc`, `remark`) VALUES
	...
	(15, 'b578ad1a-a5dc-11e8-90a9-2cfda16e4afb', 19, '123', 'SN781231', '5019', '2018-08-22', '02', '哦阿瑟东', '10:00:00', '11:00:00', '良好', '无', '管理员组', '管理员', '', '', '', '');
